...
import { Data, Format } from '../../miao-plugin/components/index.js'
import { Character, ProfileDmg, Weapon } from '../../miao-plugin/models/index.js'
import Base from '../../miao-plugin/models/Base.js'
import Attr from '../../miao-plugin/models/attr/Attr.js'
import Artis from '../../miao-plugin/models/artis/Artis.js'
import ProfileAvatar from './ProfileAvatar.js'
import ArtisMark from '../../miao-plugin/models/artis/ArtisMark.js'
import moment from 'moment'
import MysAvatar from '../../miao-plugin/models/avatar/MysAvatar.js'
...
export default class Avatar extends Base {
  ...
  get dataSource () {
    return { mys: '米游社' }[this._source] || this._source
  }
