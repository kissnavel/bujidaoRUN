import AvatarUtil from '../../miao-plugin/models/avatar/AvatarUtil.js'
import lodash from 'lodash'
import CharImg from '../../miao-plugin/models/character/CharImg.js'

import Serv from '../../miao-plugin/models/serv/Serv.js'
...
const ProfileAvatar = {
  ...
  isProfile (avatar) {
    ...
    // 检查数据源
    if (!avatar._source || !['mys'].includes(avatar._source)) {
      return false
    }
    // 检查武器及天赋
